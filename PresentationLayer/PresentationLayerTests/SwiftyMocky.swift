...
open class ConfigRepositoryProtocolMock: ConfigRepositoryProtocol, Mock {
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
            case let (.m_gitRepoReliabilityMultiplier__completion_completion(lhsCompletion), .m_gitRepoReliabilityMultiplier__completion_completion(rhsCompletion)):
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            ...
            case (.m_doing, .m_doing):
                return true
            case let (.m_done__data_data(lhsData), .m_done__data_data(rhsData)):
                guard Parameter.compare(lhs: lhsData, rhs: rhsData, with: matcher) else { return false }
                return true
            case let (.m_failure__withError_error(lhsError), .m_failure__withError_error(rhsError)):
...
open class FetchGitRepositoriesUseCaseProtocolMock: FetchGitRepositoriesUseCaseProtocol, Mock {
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
            case let (.m_execute__term_term(lhsTerm), .m_execute__term_term(rhsTerm)):
            ...
            case let (.p_delegateInterfaceAdapter_set(left), .p_delegateInterfaceAdapter_set(right)): return Parameter<FetchGitRepositoriesInterfaceAdapter?>.compare(lhs: left, rhs: right, with: matcher)
            default: return false
            }
        }
        ...
        func intValue() -> Int {
            ...
            case let .p_delegateInterfaceAdapter_set(newValue): return newValue.intValue
            }
        }
    }
...
open class GitRepoDataSourceProtocolMock: GitRepoDataSourceProtocol, Mock {
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
            case let (.m_list__term_termcompletion_completion(lhsTerm, lhsCompletion), .m_list__term_termcompletion_completion(rhsTerm, rhsCompletion)):
                guard Parameter.compare(lhs: lhsTerm, rhs: rhsTerm, with: matcher) else { return false }
                guard Parameter.compare(lhs: lhsCompletion, rhs: rhsCompletion, with: matcher) else { return false }
                return true
            case let (.m_stats__repo_repocompletion_completion(lhsRepo, lhsCompletion), .m_stats__repo_repocompletion_completion(rhsRepo, rhsCompletion)):
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            ...
            case let (.m_list__term_termcompletion_completion(lhsTerm, lhsCompletion), .m_list__term_termcompletion_completion(rhsTerm, rhsCompletion)):
                ...
                guard Parameter.compare(lhs: lhsCompletion, rhs: rhsCompletion, with: matcher) else { return false }
                return true
            case let (.m_getRepoReliabilityMultiplier__completion_completion(lhsCompletion), .m_getRepoReliabilityMultiplier__completion_completion(rhsCompletion)):
                guard Parameter.compare(lhs: lhsCompletion, rhs: rhsCompletion, with: matcher) else { return false }
                return true
            default: return false
            }
...
open class GitRepositoriesListViewModelAnalyticsProtocolMock: GitRepositoriesListViewModelAnalyticsProtocol, Mock {
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
            case let (.m_itemSelected__name_name(lhsName), .m_itemSelected__name_name(rhsName)):
                guard Parameter.compare(lhs: lhsName, rhs: rhsName, with: matcher) else { return false }
                return true
            case let (.m_searched__term_term(lhsTerm), .m_searched__term_term(rhsTerm)):
                guard Parameter.compare(lhs: lhsTerm, rhs: rhsTerm, with: matcher) else { return false }
                return true
...
open class ReliabilityRepoCalculatorUseCaseMock: ReliabilityRepoCalculatorUseCase, Mock {
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Bool {
            switch (lhs, rhs) {
            case let (.m_execute__repoStats_repoStatsmultiplier_multiplier(lhsRepostats, lhsMultiplier), .m_execute__repoStats_repoStatsmultiplier_multiplier(rhsRepostats, rhsMultiplier)):
    ...
    open class Given: StubbedMethod {
        ...
        public static func execute(repoStats: Parameter<GitRepoStatsModel>, multiplier: Parameter<Double>, willProduce: (Stubber<Double>) -> Void) -> MethodStub {
            ...
            let given: Given = { Given(method: .m_execute__repoStats_repoStatsmultiplier_multiplier(repoStats, multiplier), products: willReturn.map { StubProduct.return($0 as Any) }) }()
